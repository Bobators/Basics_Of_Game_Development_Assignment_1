I created two portals in the game and implemented teleportation between them to each other with the following script, and added teleportation cooldowns and teleportation distance offsets to avoid teleporting back and forth.
“
extends Area2D
